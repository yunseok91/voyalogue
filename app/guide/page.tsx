...
const GUIDES = [
  ...
  },
  {
    slug: 'danang-travel',
    emoji: '🇻🇳',
    title: '다낭 3박 4일 여행 코스',
    desc: '미케비치, 바나힐 황금교, 호이안 올드타운, 오행산까지. 처음 다낭 가는 분들을 위한 현실적인 일정 가이드.',
    tags: ['다낭', '베트남', '해변여행'],
  },
  {
    slug: 'bali-travel',
    emoji: '🇮🇩',
    title: '발리 5박 6일 여행 코스',
    desc: '우붓 논길 트레킹, 울루와투 절벽 사원, 스미냑 해변까지. 발리 처음이라도 여유롭게 즐길 수 있는 실전 코스.',
    tags: ['발리', '인도네시아', '리조트여행'],
  },
  {
    slug: 'bangkok-travel',
    emoji: '🇹🇭',
    title: '방콕 4박 5일 여행 코스',
    desc: '왓포, 왓아룬, 짜뚜짝 시장, 아시아티크, 카오산로드. 처음 방콕 여행도 헷갈리지 않게 정리한 완벽 코스.',
    tags: ['방콕', '태국', '도시여행'],
  },
  {
    slug: 'sim-card-guide',
    emoji: '📡',
    title: '해외 유심칩 vs 포켓와이파이',
    desc: '나라별로, 인원수에 따라 뭐가 이득인지 정리했습니다. eSIM 요즘 대세인 이유도 같이 설명합니다.',
    tags: ['유심', '통신', '여행준비'],
  },
  {
    slug: 'travel-insurance',
    emoji: '🛡️',
    title: '여행자 보험 현실적인 가입 기준',
    desc: '정말 필요한지, 얼마짜리 들면 되는지, 실제 청구는 어떻게 하는지 솔직하게 정리했습니다.',
    tags: ['보험', '의료비', '여행준비'],
  },
  {
    slug: 'duty-free-guide',
    emoji: '🛍️',
    title: '면세점 이용 가이드',
    desc: '시내면세점과 공항면세점 차이, 면세 한도, 실제로 이득인 품목과 아닌 것을 솔직하게 정리했습니다.',
    tags: ['면세점', '쇼핑', '세관'],
  },
]
